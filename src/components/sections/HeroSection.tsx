...
const HeroSection = ({ sectionId }: HeroSectionProps) => {
  ...
  return (
    <section
      id={sectionId}
      className="relative isolate flex w-full items-center justify-center px-4 pb-16 sm:px-6 lg:px-12 pt-4 sm:pt-0"
      style={{
    ...
    >
      <div className="relative z-10 grid w-full max-w-6xl gap-4 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
        <div className="hero-fade-in-delayed order-1 mx-auto w-full max-w-sm lg:order-2 lg:mx-0 lg:max-w-none">
          <div className="relative overflow-hidden rounded-3xl border border-rose-100 bg-white/85 p-4 sm:p-6 shadow-[0_30px_80px_-35px_rgba(255,0,90,0.45)] backdrop-blur">
            <div
